...
// Query: {    'chapterComponent': *[_type == 'chapterComponent'][0] {    ...,    title,    header,    image {    caption,    'assetId': asset->_id,    'assetPath': asset->path,    'aspectRatio': asset->metadata.dimensions.aspectRatio,},    timeline[] {        ...,        title,        header,        subHeader,        description[] {            ...,              _type == "link" => {    ...,    internalLink->{_type,slug,title}  },        },            },    imageGallery[] {        ...,        image {    caption,    'assetId': asset->_id,    'assetPath': asset->path,    'aspectRatio': asset->metadata.dimensions.aspectRatio,},        imageColumnStart,        imageColumnEnd,        imageRowStart,        imageRowEnd,    },    contactLink {...,   _type == "link" => {    ...,    internalLink->{_type,slug,title}  }},    applyLink {...,   _type == "link" => {    ...,    internalLink->{_type,slug,title}  }},}}
