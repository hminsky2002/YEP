    ...
    <div className="relative mx-auto mt-12 max-w-[1263px] bg-white pb-12">
      ...
      <div className="flex flex-col gap-[100px] px-[80px]">
        {teamMembers?.map((t, i) => (
          <div
            key={i}
            className={`${i % 2 === 0 ? "lg:flex-row" : "lg:flex-row-reverse lg:justify-end"}  items-center mx-auto flex flex-col gap-12`}
          >
            <div className="flex flex-col">
              ...
              {t.memberLink && (
                <h3 className="mx-auto mt-[16px] underline text-[22px]">
